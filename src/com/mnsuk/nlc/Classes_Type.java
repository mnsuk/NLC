 ...
 * @generated */
public class Classes_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Classes.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mnsuk.nlc.Classes");
 
  /** @generated */
  final Feature casFeat_class0;
  /** @generated */
  final int     casFeatCode_class0;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public String getClass0(int addr) {
        if (featOkTst && casFeat_class0 == null)
      jcas.throwFeatMissing("class0", "com.mnsuk.nlc.Classes");
    return ll_cas.ll_getStringValue(addr, casFeatCode_class0);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setClass0(int addr, String v) {
        if (featOkTst && casFeat_class0 == null)
      jcas.throwFeatMissing("class0", "com.mnsuk.nlc.Classes");
    ll_cas.ll_setStringValue(addr, casFeatCode_class0, v);}
    
  
 
  /** @generated */
  final Feature casFeat_confidence0;
  /** @generated */
  final int     casFeatCode_confidence0;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public String getConfidence0(int addr) {
        if (featOkTst && casFeat_confidence0 == null)
      jcas.throwFeatMissing("confidence0", "com.mnsuk.nlc.Classes");
    return ll_cas.ll_getStringValue(addr, casFeatCode_confidence0);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setConfidence0(int addr, String v) {
        if (featOkTst && casFeat_confidence0 == null)
      jcas.throwFeatMissing("confidence0", "com.mnsuk.nlc.Classes");
    ll_cas.ll_setStringValue(addr, casFeatCode_confidence0, v);}
  ...
  public String getClass1(int addr) {
      ...
      jcas.throwFeatMissing("class1", "com.mnsuk.nlc.Classes");
  ...
  public String getConfidence1(int addr) {
      ...
      jcas.throwFeatMissing("confidence1", "com.mnsuk.nlc.Classes");
  ...
  public String getClass2(int addr) {
      ...
      jcas.throwFeatMissing("class2", "com.mnsuk.nlc.Classes");
  ...
  public String getConfidence2(int addr) {
      ...
      jcas.throwFeatMissing("confidence2", "com.mnsuk.nlc.Classes");
  ...
  public String getClass3(int addr) {
      ...
      jcas.throwFeatMissing("class3", "com.mnsuk.nlc.Classes");
  ...
  public String getConfidence3(int addr) {
      ...
      jcas.throwFeatMissing("confidence3", "com.mnsuk.nlc.Classes");
  ...
  public String getClass4(int addr) {
      ...
      jcas.throwFeatMissing("class4", "com.mnsuk.nlc.Classes");
  ...
  public String getConfidence4(int addr) {
      ...
      jcas.throwFeatMissing("confidence4", "com.mnsuk.nlc.Classes");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Classes_Type(JCas jcas, Type casType) {
    super(jcas, casType);
    casImpl.getFSClassRegistry().addGeneratorForType((TypeImpl)this.casType, getFSGenerator());

 
    casFeat_class0 = jcas.getRequiredFeatureDE(casType, "class0", "uima.cas.String", featOkTst);
    casFeatCode_class0  = (null == casFeat_class0) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_class0).getCode();

 
    casFeat_confidence0 = jcas.getRequiredFeatureDE(casType, "confidence0", "uima.cas.String", featOkTst);
    casFeatCode_confidence0  = (null == casFeat_confidence0) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_confidence0).getCode();
