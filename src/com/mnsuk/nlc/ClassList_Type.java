 ...
 * @generated */
public class ClassList_Type extends Annotation_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = ClassList.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mnsuk.nlc.ClassList");
  ...
  public String getTopClass(int addr) {
      ...
      jcas.throwFeatMissing("topClass", "com.mnsuk.nlc.ClassList");
  ...
  public String getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "com.mnsuk.nlc.ClassList");
  ...
  public String getClass1(int addr) {
      ...
      jcas.throwFeatMissing("class1", "com.mnsuk.nlc.ClassList");
  ...
  public String getConfidence1(int addr) {
      ...
      jcas.throwFeatMissing("confidence1", "com.mnsuk.nlc.ClassList");
  ...
  public String getClass2(int addr) {
      ...
      jcas.throwFeatMissing("class2", "com.mnsuk.nlc.ClassList");
  ...
  public String getConfidence2(int addr) {
      ...
      jcas.throwFeatMissing("confidence2", "com.mnsuk.nlc.ClassList");
  ...
  public String getClass3(int addr) {
      ...
      jcas.throwFeatMissing("class3", "com.mnsuk.nlc.ClassList");
  ...
  public String getConfidence3(int addr) {
      ...
      jcas.throwFeatMissing("confidence3", "com.mnsuk.nlc.ClassList");
  ...
  public String getClass4(int addr) {
      ...
      jcas.throwFeatMissing("class4", "com.mnsuk.nlc.ClassList");
  ...
  public String getConfidence4(int addr) {
      ...
      jcas.throwFeatMissing("confidence4", "com.mnsuk.nlc.ClassList");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ClassList_Type(JCas jcas, Type casType) {
    super(jcas, casType);
